  ...
  for(var i = 0; i < produtos.length; i ++){
    ...
    <td class="input"><input type="button" value="Editar" onclick="Editar(${i})" class="editar"></td>
    <td class="input"><input type="button" value="Remover" onclick="Remover(${i})" id="remover"></td>
    </tr>`;
    }
  }
